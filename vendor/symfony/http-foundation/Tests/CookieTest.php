...
class CookieTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $cookie = new Cookie('foo', 'bar', strtotime('Fri, 20-May-2011 1:25:52 GMT'), '/', '.myfoodomain.com', true);
        $this->assertEquals('foo=bar; expires=Fri, 20-May-2011 1:25:52 GMT; path=/; domain=.myfoodomain.com; secure; httponly', $cookie->__toString(), '->__toString() returns string representation of the cookie');

...
// ??? Need to TEST if actual substitution has occurred
	...
	/*
	  ...
	  const ISC_CR = 1; //	INDIC_SYLLABIC_CATEGORY_CONSONANT_REPHA		Consonant_Repha
	  ...
	  const IMC_I	 = 1; //	INDIC_MATRA_CATEGORY_INVISIBLE		Invisible
	  const IMC_L	 = 3; //	INDIC_MATRA_CATEGORY_LEFT			Left
	  const IMC_LR = 11; //	INDIC_MATRA_CATEGORY_LEFT_AND_RIGHT		Left_And_Right
	  const IMC_x	 = 1; //	INDIC_MATRA_CATEGORY_NOT_APPLICABLE		Not_Applicable

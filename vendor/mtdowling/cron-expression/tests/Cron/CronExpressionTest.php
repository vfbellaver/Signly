...
class CronExpressionTest extends PHPUnit_Framework_TestCase
{
    ...
    public function scheduleProvider()
    {
        return array(
            ...
            // 15th minute, of the second hour, every 1 days, in January, every Friday
            ...
            array('* * * * 0', strtotime('2011-06-1 23:09:00'), '2011-06-19 00:00:00', false),
            array('* * * * 7', strtotime('2011-06-1 23:09:00'), '2011-06-19 00:00:00', false),
            array('* * * * 1', strtotime('2011-06-1 23:09:00'), '2011-06-20 00:00:00', false),
            // Should return the sunday date as 7 equals 0
            array('0 0 * * MON,SUN', strtotime('2011-06-1 23:09:00'), '2011-06-19 00:00:00', false),
            array('0 0 * * 1,7', strtotime('2011-06-1 23:09:00'), '2011-06-19 00:00:00', false),
            array('0 0 * * 0-4', strtotime('2011-06-1 23:09:00'), '2011-06-16 00:00:00', false),
            array('0 0 * * 7-4', strtotime('2011-06-1 23:09:00'), '2011-06-16 00:00:00', false),
            array('0 0 * * 4-7', strtotime('2011-06-1 23:09:00'), '2011-06-16 00:00:00', false),
            array('0 0 * * 7-3', strtotime('2011-06-1 23:09:00'), '2011-06-19 00:00:00', false),
            array('0 0 * * 3-7', strtotime('2011-06-1 23:09:00'), '2011-06-16 00:00:00', false),
            ...
            array('0 0 1 1 0', strtotime('2011-06-1 23:09:00'), '2012-01-01 00:00:00', false),
            array('0 0 1 JAN 0', strtotime('2011-06-1 23:09:00'), '2012-01-01 00:00:00', false),
            array('0 0 1 * 0', strtotime('2011-06-1 23:09:00'), '2012-01-01 00:00:00', false),
            array('0 0 L * *', strtotime('2011-07-1 00:00:00'), '2011-07-31 00:00:00', false),
            ...
            array('0 0 16W * *', strtotime('2011-07-01 00:00:00'), '2011-07-1 00:00:00', false),
    ...
    {
        $cron = CronExpression::factory('0 1 * * 3'); //Wednesday at 1:00
        $date = '2014-01-01 1:00'; //Wednesday

...
class MigrationFieldsParserSpec extends ObjectBehavior {
    ...
    function it_parses_a_string_of_fields()
    {
        ...
        $this->parse('name:string(1):nullable')->shouldReturn([
            ['field' => 'name', 'type' => 'string', 'args' => '1', 'decorators' => ['nullable']]
        ]);

        $this->parse('name:double(1,8):nullable:default(10), age:integer')->shouldReturn([
            ['field' => 'name', 'type' => 'double', 'args' => '1,8', 'decorators' => ['nullable', 'default(10)']],
            ['field' => 'age', 'type' => 'integer']
        ]);

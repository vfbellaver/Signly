                ...
                <row>
                    <column size="12">
                        ...
                        <form-group :form="form" field="monthly_impressions">
                            ...
                            <input-text v-model="form.monthly_impressions" id="monthly_impressions" name="monthly_impressions"/>
                        </form-group>     
                        <form-group :form="form" field="notes">
                            <input-label for="notes">Notes: </input-label>
                            <input-text v-model="form.notes" id="notes" name="notes"/>
                        </form-group>     
                        ...
                        <form-group :form="form" field="photo">
                            ...
                            <input-text v-model="form.photo" id="photo" name="photo"/>
                        </form-group>     
                        <form-group :form="form" field="is_iluminated">
                            <input-label for="is_iluminated">Is_Iluminated: </input-label>
                            <input-text v-model="form.is_iluminated" id="is_iluminated" name="is_iluminated"/>
                        </form-group>     

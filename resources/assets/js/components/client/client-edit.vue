                ...
                <row>
                    <column size="6">
                        ...
                        <row>
                            ...
                            <column size="4">
                                <form-group :form="form" field="phone2">
                                    ...
                                    <input-text v-model="form.phone2" id="phone2" name="phone2" placeholder="(Optional)" type="tel" v-tel></input-text>
                                </form-group>
                            </column>
                            <column size="4">
                        ...
                        <form-group :form="form" field="address_line2">
                            ...
                            <input-text v-model="form.address_line2" id="address_line2" name="address_line2" placeholder="(Optional)"></input-text>
                        </form-group>

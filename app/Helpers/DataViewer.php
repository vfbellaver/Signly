...
trait DataViewer
{
    ...
    public function scopeSearchPaginateAndOrder(Builder $query, $columns)
    {
        ...
        $v = Validator::make($request->only([
            ...
            'column' => 'required|alpha_dash|in:' . implode(',', collect($columns)->pluck('name')->toArray()),
            'direction' => 'required|in:asc,desc',
            'per_page' => 'integer|min:1',
            'search_column' => 'required|alpha_dash|in:' . implode(',', collect($columns)->pluck('name')->toArray()),
